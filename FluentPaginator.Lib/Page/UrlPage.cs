...
public record UrlPage<T>(IEnumerable<T> Items, int PageNumber, int PageSize, bool HasNext, string BaseUrl,
    string PreviousUrl, string NextUrl) : Page<T>(Items, PageNumber, PageSize, HasNext);